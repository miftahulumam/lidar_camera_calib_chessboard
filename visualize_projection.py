...
# T = np.array([[0.0290,  0.9994, -0.0167, -0.1248],
#               [0.0015, -0.0168, -0.9999, -0.0027],
#               [-0.9996, 0.0290, -0.0020, -0.0656],
#               [0.0,     0.0,     0.0,     1.0    ]]) # sept 6

# T = np.array([[0.0286,    0.9995,   -0.0094,   -0.1320],
#               [0.0010,   -0.0095,   -1.0000,   -0.0237],
#               [-0.9996,    0.0286,   -0.0013,  -0.0475],
#               [0.0,       0.0,       0.0,          1.0]]) # sept 5
