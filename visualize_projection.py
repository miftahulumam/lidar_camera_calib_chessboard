...
# using solvePnp ransac (sept 15 2025)
# T = np.array([[ 0.08631035,  0.99621896, -0.00991546, -0.16940303],
#               [-0.03293771, -0.00709379, -0.99943223, -0.02991146],
#               [-0.99572367,  0.08658794,  0.03220091, -0.85883396],
#               [ 0.,          0.,          0.,          1.        ]])

# refined solvePnP from RANSAC inliers (sept 15 2025)
T = np.array([[ 0.09241574,  0.99550553, -0.02068974, -0.14135609],
              [ 0.00642379, -0.02137431, -0.99975091,  0.12565395],
              [-0.99569979,  0.09225981, -0.00837024, -0.85802902],
              [ 0.,          0.,          0.,          1.        ]])

T = np.array([[ 0.05977377,  0.99804924, -0.01802251, -0.26412283],
                [-0.01866498, -0.01693414, -0.99968238,  0.03757397],
                [-0.99803743,  0.06009117,  0.01761636, -0.85129546],
                [ 0.,         0.,          0.,          1.        ]])
